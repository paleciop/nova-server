...
const contextProcessor = require("nova-core").contextProcessor;
...
module.exports = contextProcessor.extend({
  ...
  getPath(executionContext) {
    return executionContext.path || (executionContext.request && executionContext.request.baseUrl) || C.BLANK;
  },
  /**
